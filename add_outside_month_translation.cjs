// add_outside_month_translation.cjs
const fs = require("fs");
const FILE = "src/translations/index.js";
let src = fs.readFileSync(FILE, "utf8");

const KEY = "outsideMonth";
const VALUES = {
  no: "utenfor valgt måned",
  en: "outside selected month",
  sv: "utanför vald månad",
  da: "uden for valgt måned",
  de: "außerhalb des gewählten Monats",
  fr: "hors du mois sélectionné",
  nl: "buiten geselecteerde maand",
  it: "fuori dal mese selezionato",
  es: "fuera del mes seleccionado",
  fi: "valitun kuukauden ulkopuolella",
  pt: "fora do mês selecionado",
};
