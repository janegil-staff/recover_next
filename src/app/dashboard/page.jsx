...
export default function CalendarPage() {
  ...
  // Hydration-safe data load: render the same loading state on server and
  // first client render, then populate from sessionStorage in an effect.
  ...
  // Show loading state on the server and on first client render — both will
  // produce identical HTML, so React won't trip on hydration.
  if (!hydrated || !data)
    return (
