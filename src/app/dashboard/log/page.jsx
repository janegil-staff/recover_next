...
function LogRow({ rec, events, ctx, t, focusDate }) {
  ...
  return (
    <div
      ...
      style={{
        ...
        border: isMilestone
          ...
          : `1px solid ${isFocused ? A.replace("var(--accent)", "#4a7ab5") : BO}`,
        overflow: "hidden",
    ...
    >
      {/* Milestone banner across the top */}
      {isMilestone && (
        <div
          style={{
      ...
      >
        ...
        {/* Event badges — skip milestone here since it's in the banner */}
        <div
          style={{
            flex: 1,
            display: "flex",
      ...
      {/* Inline note preview — surfaces patient voice without needing to expand */}
      {!open && rec.note?.trim() && (
        <div
          style={{
      ...
      {open && (
        ...
        >
          {/* Event labels list — show all including milestone in expanded view */}
          {events.length > 0 && (
            <div
              style={{
                display: "flex",
